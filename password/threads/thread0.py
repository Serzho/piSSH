...
print('First thread was started at %s !!!' % time.asctime(time.localtime(time.time())))
...
'''
print('First thread was stoped at %s !!!' % time.asctime(time.localtime(time.time())))
