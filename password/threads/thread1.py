...
print('Second thread was started at %s !!!' % time.asctime(time.localtime(time.time())))
...
def end():
    print('Second thread: %s ' % PASSWORD)
                                                                ...
                                                                if(not check()):
                                                                    for j in range(len(a)):
                                                                        if((str(a[b])+str(a[c])+str(a[d])+str(a[e])+str(a[f])+str(a[g])+str(a[h])+str(a[i])+str(a[j]))==res):
                                                                           ...
                                                                           #breaking = False
'''
print('Second thread was stoped at %s !!!' % time.asctime(time.localtime(time.time())))
